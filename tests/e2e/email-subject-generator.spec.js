...
const SVC_URL = "https://appadaycreator.com/email-subject-generator/";
const SVC_NAME = "メール件名・コピー作成ヒント";

test.describe("メール件名・コピー作成ヒント - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("email-subject-generator");
